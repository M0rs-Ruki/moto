...
export default function CreateDigitalEnquiryPage() {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-xs sm:text-sm">
            Fill in the lead information and select interested models
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-sm">Interested Model</Label>
                            ...
                            {category.models.map((model) => (
                              ...
                              >
                                <input
                                  ...
                                  checked={formData.interestedModelId === model.id}
                                  onChange={() =>
                                    setFormData({
                                      ...formData,
